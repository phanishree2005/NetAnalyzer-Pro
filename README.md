...
Create processing/protocols/myprotocol.py:
...
Register it in processing/parser.py — add an instance to _PARSER_CHAIN before the fallback:
...
Optionally add a color to ui/components/packet_table.py → _PROTO_COLORS.
